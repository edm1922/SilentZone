...
const ProfileSwitch = React.forwardRef<
...
>(({ className, ...props }, ref) => (
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        "pointer-events-none block h-5 w-5 rounded-full shadow-lg ring-0 transition-transform data-[state=checked]:translate-x-5 data-[state=unchecked]:translate-x-0 data-[state=unchecked]:bg-gray-400 data-[state=checked]:bg-white"
      )}
    />
  </SwitchPrimitives.Root>
))
ProfileSwitch.displayName = SwitchPrimitives.Root.displayName
